    ...
    <main id="top">
        ...
        <Container className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <h1 className="font-display text-4xl sm:text-6xl md:text-7xl leading-[1.05] tracking-tight text-left">
              ...
              <br />
              Your{" "}
              <span className="underline underline-offset-4 decoration-2 decoration-primary">
                Interior
              </span>
              <br />
              Better.
            ...
            <p className="mt-6 max-w-md text-foreground/70">
              Boutique interior design studio creating light-filled, grounded
              spaces with purpose and quiet luxury.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                href="#portfolio"
                className="inline-flex items-center rounded-full px-5 py-3 bg-primary text-primary-foreground"
              >
                Our Projects
              </a>
              <a
                href="#journal"
                className="inline-flex items-center rounded-full px-5 py-3 border border-foreground/30 hover:border-foreground"
              >
                Stories
              </a>
            </div>
            ...
            {/* Decorative figures */}
            <svg
              className="absolute -left-8 -top-8 size-14 text-foreground/30 animate-[spin_18s_linear_infinite]"
              viewBox="0 0 100 100"
              fill="none"
            >
              <circle
            ...
            <svg
              className="absolute -left-10 top-36 w-14 h-6 text-foreground/30 animate-[wiggle_5s_ease-in-out_infinite]"
              viewBox="0 0 100 20"
              fill="none"
            >
              <path
                d="M0 10 C 10 0, 20 20, 30 10 S 50 0, 60 10 80 20, 100 10"
                stroke="currentColor"
                strokeWidth="2"
              />
            </svg>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative mx-auto w-full max-w-md">
              ...
              <div className="mt-3 flex items-center justify-center gap-6 text-foreground/60">
                <button aria-label="Previous" className="hover:text-foreground">
                  <ArrowLeft className="size-4" />
                </button>
                <button aria-label="Next" className="hover:text-foreground">
            ...
            <div className="mt-6 flex items-center gap-4 justify-center md:justify-start">
              <button
                ...
                className="p-2 rounded-full border border-foreground/30 hover:border-foreground"
              >
      ...
      <section className="py-12 md:py-16">
        <Container className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div className="mt-4 inline-block border-b border-foreground/40 group-hover:border-foreground">
              Explore →
            </div>
          </a>
          <a
      ...
      <section className="py-20 md:py-28" id="about-us">
        <Container className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <p className="text-foreground/70 leading-relaxed text-base md:text-lg">
            ...
            minimalism and quiet luxury, our approach is about creating
            interiors that feel grounded and luminous.
          </p>
        </Container>
      </section>
      ...
      <section className="py-16 md:py-24" id="builds">
        <Container>
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            ...
            />
            <img
              className="w-full h-44 object-cover rounded hidden md:block"
              alt="Hospitality"
      ...
      <section className="relative isolate overflow-hidden" id="journal">
        ...
        <Container className="py-24 md:py-40 text-center">
          <div className="uppercase text-xs tracking-[0.2em] text-foreground/80">
            Process
          </div>
